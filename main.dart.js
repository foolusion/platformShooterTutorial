...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|Blob|CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var g = new D.Game(null, null, null, null, null, null, null, 32, null);
    g.Game$1("#game");
    g.gameLoop$0();
  }, "call$0", "main$closure", 0, 0, 1]
},
1],
["platformShooter", "package:platformShooterTutorial/platformShooter/platformShooter.dart", , D, {
  "^": "",
  Game: {
    "^": "Object;canvas,ctx,world,p,entities,time,wallTime,maxStep,debug",
    gameLoop$1: [function(_) {
      var t1, t2, dt, dt0, s;
      C.Window_methods.get$animationFrame(window).then$1(this.get$gameLoop());
      t1 = Date.now();
      t2 = this.wallTime;
      if (typeof t2 !== "number")
        return H.iae(t2);
      ...
      if (dt > dt0)
        dt = dt0;
      for (t1 = this.entities, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.input$0();
      for (t1 = this.entities, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.update$1(dt);
      this.ctx.clearRect(0, 0, J.get$width$x(this.canvas), J.get$height$x(this.canvas));
      this.ctx.save();
      s = E.Box$(0, 0, J.get$width$x(this.canvas), J.get$height$x(this.canvas));
      t1 = this.p.platformShooter$Player$box.get$center();
      t2 = t1._x - s._w / 2;
      s._x = t2;
      s._y = t1._y - s._h / 2;
      this.ctx.translate(-C.JSNumber_methods.toInt$0(t2), -C.JSNumber_methods.toInt$0(s._y));
      this.world.draw$0();
      for (t1 = this.entities, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
        t1._current.draw$0();
      this.ctx.restore();
      this.debug.textContent = H.S(C.JSInt_methods.$tdiv(1000, dt));
    }, function() {
      return this.gameLoop$1(null);
    }, "gameLoop$0", "call$1", "call$0", "get$gameLoop", 0, 2, 19, 13],
    Game$1: function(selector) {
      var t1, t2, t3;
      t1 = document.querySelector(selector);
      this.canvas = t1;
      J.set$width$x(t1, 640);
      J.set$height$x(this.canvas, 480);
      this.ctx = J.get$context2D$x(this.canvas);
      this.world = D.World$(this);
      t1 = new D.Player(this, null, null, E.Box$(50, 30, 20, 50), "flying", 0.046875, -0.5, 0.046875, 6, null, null);
      t1.i = D.PlayerInput$();
      t2 = new E.Vector2(null, null);
      t2._x = 0;
      t2._y = 0;
      t1.platformShooter$Player$velocity = t2;
      this.p = t1;
      t1 = H.setRuntimeTypeInfo([], [D.Entity]);
      this.entities = t1;
      t2 = new E.Vector2(null, null);
      t2._x = 100;
      t2._y = 100;
      t3 = new E.Vector2(null, null);
      t3._x = 0;
      t3._y = 0;
      t3 = new D.Static(this, t2, t3, null, null, null);
      t3._box = E.Box$(100, 100, 100, 100);
      t1.push(t3);
      t3 = this.entities;
      t1 = new E.Vector2(null, null);
      t1._x = 400;
      t1._y = 100;
      t2 = new E.Vector2(null, null);
      t2._x = 0;
      t2._y = 0;
      t2 = new D.Static(this, t1, t2, null, null, null);
      t2._box = E.Box$(400, 100, 100, 100);
      t3.push(t2);
      t2 = this.entities;
      t3 = new E.Vector2(null, null);
      t3._x = 50;
      ...
      t1._x = 0;
      t1._y = 0;
      t1 = new D.Static(this, t3, t1, null, null, null);
      t1._box = E.Box$(50, 400, 500, 50);
      t2.push(t1);
      this.entities.push(this.p);
      t1 = this.entities;
      t2 = E.Box$(0, 0, 10, 10);
      t3 = new E.Vector2(null, null);
      t3._x = 2;
      t3._y = 1;
      t2 = new D.Bouncer(this, null, t2, 1000, "rgb(0,255,255)", null, null);
      t2.platformShooter$Bouncer$velocity = t3.normalize$0();
      t1.push(t2);
      t2 = this.entities;
      t1 = E.Box$(200, 200, 100, 100);
      t3 = new E.Vector2(null, null);
      t3._x = -1;
      t3._y = -1;
      t1 = new D.Bouncer(this, null, t1, 60, "rgba(127, 127, 255, .5)", null, null);
      t1.platformShooter$Bouncer$velocity = t3.normalize$0();
      t2.push(t1);
      t1 = this.entities;
      t2 = E.Box$(234, 98, 30, 60);
      t3 = new E.Vector2(null, null);
      t3._x = 1;
      t3._y = 3;
      t2 = new D.Bouncer(this, null, t2, 300, "rgb(0,0,255)", null, null);
      t2.platformShooter$Bouncer$velocity = t3.normalize$0();
      t1.push(t2);
      this.time = 0;
  ...
  PlayerInput: {
    "^": "Input;keys,actions",
    action$1: function(_, s) {
      var a = this.actions.$index(0, s);
      if (a == null)
        return false;
      return a;
    },
    PlayerInput$0: function() {
      this.keys = H.setRuntimeTypeInfo(Array(256), [P.String]);
      this.actions = P.LinkedHashMap_LinkedHashMap(null, null, null, P.String, P.bool);
      var t1 = this.keys;
      t1[37] = "left";
      t1[38] = "up";
      t1[39] = "right";
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.PlayerInput_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new D.PlayerInput_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {PlayerInput$: function() {
        var t1 = new D.PlayerInput(null, null);
        t1.PlayerInput$0();
        return t1;
      }}
  },
  PlayerInput_closure: {
    ...
    call$1: function($event) {
      ...
      t2 = t1.actions;
      t1 = t1.keys;
      t3 = J.get$keyCode$x($event);
      if (t3 >>> 0 !== t3 || t3 >= 256)
        return H.ioore(t1, t3);
      t2.$indexSet(0, t1[t3], true);
      return true;
    }
  },
  PlayerInput_closure0: {
    "^": "Closure:8;this_1",
    call$1: function($event) {
      var t1, t2, t3;
      t1 = this.this_1;
  ...
  Static: {
    "^": "Entity;g,position,velocity:platformShooter$Static$velocity<,_box,box,velocity",
    get$box: function() {
      return this._box;
    },
    input$0: function() {
    ...
    draw$0: function() {
      ...
      t2 = this._box;
      t1.fillRect(t2._x, t2._y, t2._w, t2._h);
    }
  },
  Bouncer: {
    "^": "Entity;g,velocity:platformShooter$Bouncer$velocity<,box:platformShooter$Bouncer$box<,speed,color,box,velocity",
    input$0: function() {
    },
    update$1: function(dt) {
      var t1, t2, t3, t4, pp, bb, e;
      t1 = this.platformShooter$Bouncer$box;
      t2 = t1._x;
      t1 = t1._y;
      t3 = new E.Vector2(null, null);
      t3._x = t2;
      t3._y = t1;
      t1 = this.platformShooter$Bouncer$velocity;
      t2 = this.speed;
      t4 = t1._x * t2;
      t2 = t1._y * t2;
      t1 = new E.Vector2(null, null);
      ...
      t1 = pp._x;
      t3 = pp._y;
      t2 = this.platformShooter$Bouncer$box;
      bb = E.Box$(t1, t3, t2._w, t2._h);
      t1 = bb._x;
      if (t1 < 0) {
        bb._x = 0;
        t1 = this.platformShooter$Bouncer$velocity;
        ...
        t2 = bb._w;
        t3 = this.g;
        t4 = J.get$width$x(t3.canvas);
        if (typeof t4 !== "number")
          return H.iae(t4);
        if (t1 + t2 > t4) {
          bb._x = J.toDouble$0$n(J.get$width$x(t3.canvas)) - bb._w;
          t1 = this.platformShooter$Bouncer$velocity;
          t1._x = -t1._x;
        }
      }
      ...
      if (t1 < 0) {
        ...
        t2 = bb._h;
        t3 = this.g;
        t4 = J.get$height$x(t3.canvas);
        if (typeof t4 !== "number")
          return H.iae(t4);
        if (t1 + t2 > t4) {
          bb._y = J.toDouble$0$n(J.get$height$x(t3.canvas)) - bb._h;
          t1 = this.platformShooter$Bouncer$velocity;
          t1._y = -t1._y;
        }
      }
      for (t1 = this.g.entities, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        e = t1._current;
        if (this === e)
          continue;
        if (bb.intersects$1(e.get$box())) {
          t2 = this.platformShooter$Bouncer$box;
          if (t2._x + t2._w <= e.get$box()._x && bb._x + bb._w > e.get$box()._x) {
            bb._x = C.JSNumber_methods.toDouble$0(e.get$box()._x) - bb._w;
            t2 = this.platformShooter$Bouncer$velocity;
            t2._x = -t2._x;
          }
          t2 = this.platformShooter$Bouncer$box._x;
          t3 = e.get$box();
          if (t2 >= t3._x + t3._w) {
            t2 = bb._x;
            t3 = e.get$box();
          ...
          t2 = this.platformShooter$Bouncer$box._y;
          t3 = e.get$box();
          if (t2 >= t3._y + t3._h) {
            t2 = bb._y;
            t3 = e.get$box();
          ...
          t2 = this.platformShooter$Bouncer$box;
          if (t2._y + t2._h <= e.get$box()._y && bb._y + bb._h > e.get$box()._y) {
            bb._y = C.JSNumber_methods.toDouble$0(e.get$box()._y) - bb._h;
            t2 = this.platformShooter$Bouncer$velocity;
            t2._y = -t2._y;
          }
        }
      }
      this.platformShooter$Bouncer$box = bb;
    },
    draw$0: function() {
      var t1, t2;
      t1 = this.g.ctx;
      t1.fillStyle = this.color;
      t2 = this.platformShooter$Bouncer$box;
      t1.fillRect(t2._x, t2._y, t2._w, t2._h);
    }
  },
  Player: {
    "^": "Entity;g,i,velocity:platformShooter$Player$velocity<,box:platformShooter$Player$box<,state,acc,dec,frc,top,box,velocity",
    input$0: function() {
      var t1, t2, t3, t4;
      if (J.$eq(this.i.action$1(0, "left"), true)) {
        t1 = this.platformShooter$Player$velocity;
        t2 = t1._x;
        if (t2 > 0)
          t1._x = this.dec;
        else {
      ...
      } else if (J.$eq(this.i.action$1(0, "right"), true)) {
        t1 = this.platformShooter$Player$velocity;
        t2 = t1._x;
        if (t2 < 0)
          t1._x = -this.dec;
        ...
        t1 = this.platformShooter$Player$velocity;
        t2 = t1._x;
        t3 = P.min(Math.abs(t2), this.frc);
        t4 = this.platformShooter$Player$velocity._x;
        if (t4 > 0)
          t4 = 1;
        else if (t4 < 0)
          t4 = -1;
      ...
      if (J.$eq(this.i.action$1(0, "jump"), true) && this.state !== "flying") {
        this.platformShooter$Player$velocity._y -= 6;
        this.state = "flying";
      }
    },
    update$1: function(dt) {
      ...
      t1 = this.platformShooter$Player$box;
      t2 = t1._x;
      t1 = t1._y;
      t3 = new E.Vector2(null, null);
      t3._x = t2;
      ...
      for (t1 = this.g.entities, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
        ...
        if (this === e)
          continue;
        if (bb.intersects$1(e.get$box())) {
          t2 = this.platformShooter$Player$box;
          if (t2._x + t2._w <= e.get$box()._x && bb._x + bb._w > e.get$box()._x) {
            bb._x = C.JSNumber_methods.toDouble$0(e.get$box()._x) - bb._w;
            t2 = e.get$velocity()._x;
            if (t2 > 0)
              t2 = 1;
            else if (t2 < 0)
              t2 = -1;
            t3 = this.platformShooter$Player$velocity;
            t4 = t3._x;
            if (t4 > 0)
              t4 = 1;
            else if (t4 < 0)
              t4 = -1;
            if (t2 === t4)
              t3._x = P.min(e.get$velocity()._x, this.platformShooter$Player$velocity._x);
            else
              t3._x = 0;
          }
          t2 = this.platformShooter$Player$box._x;
          t3 = e.get$box();
          if (t2 >= t3._x + t3._w) {
            t2 = bb._x;
            t3 = e.get$box();
          ...
          t2 = this.platformShooter$Player$box._y;
          t3 = e.get$box();
          if (t2 >= t3._y + t3._h) {
            t2 = bb._y;
            t3 = e.get$box();
          ...
          if (t2) {
            t2 = e.get$box();
            bb._y = t2._y + t2._h;
            this.platformShooter$Player$velocity._y = 0;
          }
          t2 = this.platformShooter$Player$box;
          if (t2._y + t2._h <= e.get$box()._y && bb._y + bb._h > e.get$box()._y) {
            bb._y = C.JSNumber_methods.toDouble$0(e.get$box()._y) - bb._h;
      ...
      this.platformShooter$Player$box = bb;
    },
    draw$0: function() {
      var t1, t2, t3;
      t1 = this.g;
      t2 = t1.ctx;
      t2.fillStyle = "rgb(255, 0, 0)";
      t3 = this.platformShooter$Player$box;
      t2.fillRect(t3._x, t3._y, t3._w, t3._h);
      t1.ctx.save();
      t3 = t1.ctx;
      t3.strokeStyle = "rgb(0,255,0)";
      t3.translate(this.platformShooter$Player$box.get$center()._x, this.platformShooter$Player$box.get$center()._y);
      t1.ctx.beginPath();
      t1.ctx.moveTo(0, 0);
      t3 = t1.ctx;
      t2 = this.platformShooter$Player$velocity;
      t3.lineTo(t2._x * 16, t2._y * 16);
      t1.ctx.closePath();
      t1.ctx.stroke();
      t1.ctx.restore();
    }
  ...
  GroundTile: {
    ...
    draw$0: function() {
      ...
      t2 = t1.ctx;
      t3 = this.box;
      t2.translate(t3._x, t3._y);
      t3 = t1.ctx;
      t3.fillStyle = "DarkSeaGreen";
      t2 = this.box;
      t3.fillRect(0, 0, t2._w, t2._h);
      t1.ctx.restore();
    }
  },
  AirTile: {
  ...
  World: {
    "^": "Object;g,TILES_PER_ROW,world",
    draw$0: function() {
      var t1;
      for (t1 = this.world, t1.length, t1 = new H.ListIterator(t1, 1200, 0, null); t1.moveNext$0();)
        t1._current.draw$0();
    },
    World$1: function(g) {
      var t1, rand, t2, i, t3, t4, b;
      this.world = H.setRuntimeTypeInfo(Array(1200), [D.Tile]);
      t1 = Date.now();
      rand = P._Random$(t1);
      for (t1 = this.TILES_PER_ROW, t2 = this.g, i = 0; this.world.length, i < 1200; ++i) {
        t3 = C.JSInt_methods.$mod(i, t1);
        t4 = C.JSInt_methods.$tdiv(i, t1);
        b = new E.Box(null, null, null, null);
        b._x = t3 * 16;
        b._y = t4 * 16;
        b._w = C.JSInt_methods.toDouble$0(16);
        b._h = C.JSInt_methods.toDouble$0(16);
        switch (rand.nextInt$1(3) + 1) {
          case 1:
            t3 = this.world;
            t4 = new D.GroundTile(t2, null, null, null);
            t4.box = b;
            t4.type = 1;
            t4.isSolid = true;
            t3[i] = t4;
          ...
          case 2:
            t3 = this.world;
            t4 = new D.AirTile(t2, null, null, null);
            t4.box = b;
            t4.type = 2;
            t4.isSolid = false;
            t3[i] = t4;
          ...
          case 3:
            t3 = this.world;
            t4 = new D.DirtTile(t2, null, null, null);
            t4.box = b;
            t4.type = 3;
            t4.isSolid = true;
            t3[i] = t4;
    ...
    static: {World$: function(g) {
        var t1 = new D.World(g, 40, null);
        t1.World$1(g);
        return t1;
      }}
  }
}],
["util", "package:platformShooterTutorial/util/util.dart", , E, {
  "^": "",
  Box: {
    "^": "Object;_x,_y,_w,_h",
    get$center: function() {
      ...
      t3 = this._y;
      t4 = this._h;
      t5 = new E.Vector2(null, null);
      t5._x = t1 + t2 / 2;
      t5._y = t3 + t4 / 2;
      return t5;
    },
    intersects$1: function(b) {
      var t1, t2;
      t1 = this._x;
      t2 = b._x;
      if (t1 >= t2 + b._w)
    ...
    Box$4: function(x, y, w, h) {
      this._x = x;
      this._y = y;
      this._w = J.toDouble$0$n(w);
      this._h = J.toDouble$0$n(h);
    },
    static: {Box$: function(x, y, w, h) {
        var t1 = new E.Box(null, null, null, null);
        t1.Box$4(x, y, w, h);
        return t1;
      }}
  },
...
;(function() {
  ...
  _.$isDuration = TRUE;
  _.$isObject = TRUE;
  D.Entity.$isObject = TRUE;
  _ = P.bool;
  _.$isbool = TRUE;
  _.$isObject = TRUE;
  D.Tile.$isObject = TRUE;
